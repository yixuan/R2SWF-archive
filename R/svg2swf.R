# Currently this function could only parse svg files created by
# the cairo graphics library, typically from svg() in the grDevices
# package (R >= 2.14.0 required for Windows OS), and CairoSVG() in the
# Cairo package.
